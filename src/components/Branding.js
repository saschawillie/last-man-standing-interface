    ...
    <Box sx={{ p: 5, ml: 3, flexGrow: 1, height: "100%" }}>
      <Box
        sx={{
          ...
          background:
            "#00000000 box, linear-gradient(to right top, #3687ff, #5579fa, #6f69f2, #8655e7, #9b3cd8) border-box",
      ...
      >
        <Box component="span" sx={{ display: "flex", alignItems: "flex-end", mb: 1 }}>
          <Typography variant="h5" sx={{ lineHeight: 0.7 }}>
            Be the
          </Typography>
        </Box>
        <Typography variant="h1" sx={{ lineHeight: 1, fontSize: 40, fontWeight: "900" }}>
          LAST MAN
        </Typography>
