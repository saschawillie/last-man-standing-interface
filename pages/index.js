...
import { GameInfo, NoMetamask } from "../src/components";
import { useEffect, useState } from "react";
import { Topbar, Jackpot, Staker, Rewards, Wrapper, Branding } from "../src/components/";
    ...
    <Box>
      ...
      >
        ...
        <Box
          component="img"
          src="/smudge2.svg"
          sx={{ position: "absolute", zIndex: -1, bottom: "-20%", left: "-20%", height: "70%" }}
        />
        <Topbar />
        <Jackpot />
